...
# define USB_REGISTER(reg, addr)		__xdata volatile __at (addr) reg
#else
# define USB_REGISTER(reg, addr)		extern __xdata volatile reg
#endif
...
#ifdef DEFINE_USB_REGS
# define USB_REGISTER(reg, addr)		xdata volatile reg __at addr
#else
# define USB_REGISTER(reg, addr)		extern xdata volatile reg
#endif
